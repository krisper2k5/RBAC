...
-H "Content-Type: application/json" \
-d '{"name":"Алексей Смирнов","email":"alex@taxi.test","phone":"+79994445566","licenseNumber":"MSK001"}'

curl -X POST http://localhost:8081/drivers \
-H "Content-Type: application/json" \
-d '{"name":"Дмитрий Козлов","email":"dmitry@taxi.test","phone":"+79997778899","licenseNumber":"MSK002"}'
...
-H "Content-Type: application/json" \
-d '{"passengerId":1,"origin":"Красная площадь","destination":"ВДНХ","distanceKm":12.5}'
